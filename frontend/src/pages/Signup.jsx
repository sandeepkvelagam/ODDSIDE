...
import { Eye, EyeOff, ChevronLeft, AlertCircle, WifiOff } from "lucide-react";
...
export default function Signup() {
  ...
  const handleSubmit = async (e) => {
    ...
    if (!name || !email || !password) {
      setError({ code: ErrorCode.AUTH_SIGNUP_FAILED, message: "Please fill in all fields." });
      return;
    }
          ...
          <div>
            ...
            <div className="relative mt-2">
              <Input
                ...
                className={`bg-[#1a1a1a] border-gray-700 text-white placeholder:text-gray-500 h-12 rounded-xl pr-10 ${error?.code === ErrorCode.AUTH_SIGNUP_FAILED ? 'border-red-500' : ''}`}
