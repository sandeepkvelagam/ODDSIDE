...
export function AIAssistantScreen() {
  ...
  const chatHeightAnim = useRef(new Animated.Value(1)).current;
  ...
  const sendMessage = async (text: string) => {
    ...
    try {
      ...
      setMessages((prev) => [
        ...prev,
        { role: "assistant", content: "Sorry, I couldn't process that. Please try again later.", error: true },
      ]);
    } finally {
      setLoading(false);
    }
  ...
  return (
    <View style={[styles.container, { paddingTop: insets.top }]}>
        ...
        <View style={styles.headerCenter}>
          ...
          <View>
            ...
            <Text style={styles.headerSubtitle}>
              {chatVisible ? "Ask me anything" : `${messages.length - 1} messages`}
            </Text>
          </View>
        </View>
      ...
      {/* Minimized pill — shown when chat is hidden */}
      {!chatVisible && (
        <TouchableOpacity
...
const styles = StyleSheet.create({
  ...
  messageBubbleError: {
    backgroundColor: COLORS.glass.glowRed, borderWidth: 1, borderColor: "rgba(239, 68, 68, 0.3)",
  },
  messageText: {
    color: COLORS.text.primary, fontSize: TYPOGRAPHY.sizes.bodySmall, lineHeight: 20,
  },
  messageTextUser: { color: "#ffffff" },
  suggestionsContainer: {
    paddingHorizontal: SPACING.container, paddingVertical: SPACING.md,
    borderTopWidth: 1, borderTopColor: COLORS.glass.border,
  },
  suggestionsLabel: {
    color: COLORS.text.muted, fontSize: TYPOGRAPHY.sizes.caption, marginBottom: SPACING.sm,
  },
  ...
  suggestionText: { color: COLORS.text.secondary, fontSize: TYPOGRAPHY.sizes.caption },
  inputContainer: {
    paddingHorizontal: SPACING.container, paddingTop: SPACING.md,
    borderTopWidth: 1, borderTopColor: COLORS.glass.border, backgroundColor: COLORS.jetDark,
  },
  inputWrapper: {
    flexDirection: "row", alignItems: "center",
    backgroundColor: COLORS.glass.bg, borderRadius: RADIUS.xxl,
  ...
  input: {
    ...
    fontSize: TYPOGRAPHY.sizes.body, paddingVertical: SPACING.md,
  },
  sendButton: {
