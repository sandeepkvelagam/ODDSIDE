...
export const getThemedColors = (isDark: boolean, themeColors: Record<string, string>) => {
  if (isDark) {
    return {
      ...
      glowBlue: "rgba(59, 130, 246, 0.15)",
      glowWarning: "rgba(245, 158, 11, 0.15)",
      cardSlotBg: "rgba(255, 255, 255, 0.12)",
      suitBlack: "#F5F5F5",
      dashedBorder: "rgba(255, 255, 255, 0.25)",
  ...
  return {
    ...
    glowRed: "rgba(239, 68, 68, 0.10)",
    glowGreen: "rgba(34, 197, 94, 0.10)",
    glowBlue: "rgba(59, 130, 246, 0.10)",
    glowWarning: "rgba(245, 158, 11, 0.10)",
    cardSlotBg: "rgba(0, 0, 0, 0.06)",
    suitBlack: "#1a1a1a",
    dashedBorder: "rgba(0, 0, 0, 0.20)",
